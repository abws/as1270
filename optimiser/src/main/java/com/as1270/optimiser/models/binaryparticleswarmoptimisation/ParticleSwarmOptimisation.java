package com.as1270.optimiser.models.binaryparticleswarmoptimisation;
...
public class ParticleSwarmOptimisation {
    ...
    public ParticleSwarmOptimisation(int swarmSize, double c1, double c2, double k, int maxIterations, boolean useRing, Problem problem) {
    ...
    */
    public double[][] run(WebSocketSession session, ObjectMapper objectMapper) throws IOException {
        ...
        while (iteration < maxIterations) {
            ...
            session.sendMessage(new TextMessage(objectMapper.writeValueAsString(problem.gBestFitness)));
        ...
        return problem.decode(problem.gBest);
    }
