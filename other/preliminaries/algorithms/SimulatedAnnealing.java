...
public class SimulatedAnnealing {
     ...
     */
    public int simulatedAnnealing(ProblemConstrainedQuadratic problem) { //change to generic problem later
        ...
        while (iterations != 0) {
            ...
            double probability = getProbability(current, next, problem);
