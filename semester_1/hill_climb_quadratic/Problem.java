...
public class Problem {
    ...
    public boolean isEdge(int input) {
        ...
        /* 
        if (input > lowerBound) return new ArrayList<>(Arrays.asList(true, "l"));
        if (input < upperBound) return new ArrayList<>(Arrays.asList(true, "r"));
        else return new ArrayList<>(Arrays.asList(false, "n"));
        */
    }
